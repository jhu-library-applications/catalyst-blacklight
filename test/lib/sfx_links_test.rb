...
class SfxLinksTest < ActiveSupport::TestCase
  def setup
    @open_url_query_string = { 'url_ver' => 'Z39.88-2004', 'url_ctx_fmt' => 'info:ofi/fmt:kev:mtx:ctx',
                               ...
                               'controller' => 'external_resources', 'action' => 'show' }.to_query
